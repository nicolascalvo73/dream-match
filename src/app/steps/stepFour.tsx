...
const StepFour: React.FC<StepProps> = ({ goToStep, prevStep }) => {
	...
	return (
		<div className="w-full h-screen flex flex-col items-center justify-center bg-whity">
			...
			{showSearch && <PlayerSeeker onClose={() => setShowSearch(false)} team={'team2'} />}
